package pl.redheadsolutions.lg.lets.vote.gateway.config.timezone;
...
import pl.redheadsolutions.lg.lets.vote.gateway.config.SecurityBeanOverrideConfiguration;
import pl.redheadsolutions.lg.lets.vote.gateway.repository.timezone.DateTimeWrapper;
import pl.redheadsolutions.lg.lets.vote.gateway.repository.timezone.DateTimeWrapperRepository;

/**
 * Integration tests for the ZoneId Hibernate configuration.
 */
@SpringBootTest(classes = { SecurityBeanOverrideConfiguration.class, LetsVoteGatewayApp.class })
