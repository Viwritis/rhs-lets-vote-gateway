...
@RestController
@RequestMapping("/api/lets-vote-gateway-kafka")
public class LetsVoteGatewayKafkaResource {
    private final Logger log = LoggerFactory.getLogger(LetsVoteGatewayKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public LetsVoteGatewayKafkaResource(KafkaProperties kafkaProperties) {
